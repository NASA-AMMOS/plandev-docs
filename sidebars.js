...
const sidebars = {
          ...
          items: [
            {
              ...
              items: [
                ...
                'overview/design/arch-decision-records/adr-0004-typescript-edsls',
                'overview/design/arch-decision-records/adr-0005-sequencing-typescript',
                'overview/design/arch-decision-records/adr-0006-seqdev-editor',
                'overview/design/arch-decision-records/adr-0100-seqdev-sde',
                'overview/design/arch-decision-records/adr-0101-seqdev-actions',
              ],
            },
          ...
          items: [
            {
              ...
              items: [
                ...
                'scheduling-and-constraints/declarative/constraints/examples',
                {
                  label: 'EDSL Docs',
                  type: 'link',
                  href: 'https://nasa-ammos.github.io/plandev/constraints-edsl-api/',
                },
              ],
            },
            {
              ...
              items: [
                ...
                'scheduling-and-constraints/declarative/scheduling/temporal-subset',
                {
                  label: 'EDSL Docs',
                  type: 'link',
                  href: 'https://nasa-ammos.github.io/plandev/scheduling-edsl-api/modules/Scheduling_eDSL.html',
                },
              ],
            },
          ],
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          label: 'Contrib',
          type: 'link',
          href: 'https://nasa-ammos.github.io/plandev/javadoc/contrib/',
        },
        {
          label: 'Examples - Banananation',
          type: 'link',
          href: 'https://nasa-ammos.github.io/plandev/javadoc/examples/banananation/',
        },
        {
          label: 'Examples - Config With Defaults',
          type: 'link',
          href: 'https://nasa-ammos.github.io/plandev/javadoc/examples/config-with-defaults/',
        },
        {
          label: 'Examples - Config Without Defaults',
          type: 'link',
          href: 'https://nasa-ammos.github.io/plandev/javadoc/examples/config-without-defaults/',
        },
        {
          label: 'Examples - Foo Mission Model',
          type: 'link',
          href: 'https://nasa-ammos.github.io/plandev/javadoc/examples/foo-missionmodel/',
        },
        {
          label: 'Merlin Driver',
          type: 'link',
          href: 'https://nasa-ammos.github.io/plandev/javadoc/merlin-driver/',
        },
        {
          label: 'Merlin Framework',
          type: 'link',
          href: 'https://nasa-ammos.github.io/plandev/javadoc/merlin-framework/',
        },
        {
          label: 'Merlin Framework JUnit',
          type: 'link',
          href: 'https://nasa-ammos.github.io/plandev/javadoc/merlin-framework-junit/',
        },
        {
          label: 'Merlin Framework Processor',
          type: 'link',
          href: 'https://nasa-ammos.github.io/plandev/javadoc/merlin-framework-processor/',
        },
        {
          label: 'Merlin SDK',
          type: 'link',
          href: 'https://nasa-ammos.github.io/plandev/javadoc/merlin-sdk/',
        },
        {
          label: 'Merlin Server',
          type: 'link',
          href: 'https://nasa-ammos.github.io/plandev/javadoc/merlin-server/',
        },
        {
          label: 'Merlin Worker',
          type: 'link',
          href: 'https://nasa-ammos.github.io/plandev/javadoc/merlin-worker/',
        },
        {
          label: 'Parsing Utilities',
          type: 'link',
          href: 'https://nasa-ammos.github.io/plandev/javadoc/parsing-utilities/',
        },
        {
          label: 'Procedural APIs',
          type: 'link',
          href: 'https://nasa-ammos.github.io/plandev/procedural-apis',
        },
        {
        ...
        },
        {
          ...
          type: 'link',
          href: 'https://nasa-ammos.github.io/plandev/javadoc/scheduler-server/',
        },
        {
          label: 'Scheduler Worker',
          type: 'link',
          href: 'https://nasa-ammos.github.io/plandev/javadoc/scheduler-worker/',
        },
      ],
    },
    'glossary',
  ...
  upgradeGuides: [
    'upgrade-guides/4-3-0-to-4-4-0',
    'upgrade-guides/4-2-1-to-4-3-0',
    'upgrade-guides/4-2-0-to-4-2-1',
    ...
    'upgrade-guides/3-5-1-to-3-5-2',
    'upgrade-guides/3-5-1-to-3-6-0',
    'upgrade-guides/3-5-0-to-3-5-1',
    'upgrade-guides/3-4-0-to-3-5-0',
    'upgrade-guides/3-3-1-to-3-4-0',
