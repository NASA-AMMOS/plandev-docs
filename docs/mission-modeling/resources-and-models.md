...
A derived resource is constructed from an existing resource given a mapping transformation. For example, the [Imager class](https://github.com/NASA-AMMOS/plandev/blob/develop/examples/foo-missionmodel/src/main/java/gov/nasa/ammos/plandev/foomissionmodel/models/Imager.java) sample model defines an "imaging in progress" resource with:
...
For example, the [Mission class](https://github.com/NASA-AMMOS/plandev/blob/develop/examples/foo-missionmodel/src/main/java/gov/nasa/ammos/plandev/foomissionmodel/Mission.java) sample model defines a "battery state of charge" resource with:
...
The `contrib` package is a rich source of example models. See [the repository](https://github.com/NASA-AMMOS/plandev/tree/develop/contrib/src/main/java/gov/nasa/ammos/plandev/contrib/models) for more details.
