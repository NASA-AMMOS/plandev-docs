...
The PlanDev modeling framework provides a [simulation configuration](https://ammos.nasa.gov/plandev-docs/mission-modeling/configuration/) interface to satisfy this need.
