...
In the PlanDev UI, navigate back to the plan view for our previously created plan and select `Scheduling Goals` from the top-left drop-down menu. From there, click `Manage Goals` and then the `New` button to be directed to creating/uploading a new scheduling goal.
