# ADR-0006 - SeqDev Editor with SeqN Language
...
- Tying SeqDev to the activity planning portion of PlanDev could cause issues if a mission wants to take SeqDev updates without taking activity planning updates, especially if those updates include breaking changes.
