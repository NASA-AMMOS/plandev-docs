...
- **Mission model** - The term "adaptation" has become significantly
  ...
  which run as a PlanDev simulation. It's specific as to the purpose of
...
windows where certain conditions are met. A PlanDev constraint is a
...
API. As shown in the Figure below, a PlanDev developed and maintained
