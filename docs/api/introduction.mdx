...
To get a token from the gateway UI you can visit [http://localhost:9000/#/Auth/post_auth_login](http://localhost:9000/#/Auth/post_auth_login), and enter your Aerie username and password (change `localhost` do your deployment URL if you are running Aerie on a different domain).
