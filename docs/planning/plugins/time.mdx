...
Below is a basic example that sets the additional time formats to a single format that displays the current UTC year. For additional plugin examples, please refer to the [plugin examples repository](https://github.com/NASA-AMMOS/aerie-ui-plugin-examples).
