...
To export a PlanDev plan, first open it in PlanDev, then open the "Plan Metadata" panel. Use the export button in the top
...
On the Plans page, you can select a PlanDev plan file to upload when creating a new plan. This will pre-populate
