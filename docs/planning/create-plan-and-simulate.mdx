import createPlan from './assets/create-plan.mp4';
import firstSimulation from './assets/first-simulation.mp4';

# Create Plan and Simulate

Here we describe how to create a new plan and simulate it using the [PlanDev UI](https://github.com/NASA-AMMOS/plandev-ui).
...
1. Navigate to the `/plans` page in the PlanDev UI. If you are running PlanDev locally it is at [http://localhost/plans](http://localhost/plans).
