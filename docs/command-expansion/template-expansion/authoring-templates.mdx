...
To create a new sequence template for an activity type (or to edit existing ones) navigate to the **Sequence Templates** page of PlanDev.

<figure>
  <img alt="PlanDev UI - Templates Page" src={templatePage} />
