...
PlanDev requires an expansion set to expand simulated activities into time ordered commands.
...
<figure>
  <img alt="PlanDev UI - Expansion Sets Page" src={setsPage} />
  <figcaption>Figure 1: PlanDev UI Expansion Sets Page - View or delete expansion sets</figcaption>
</figure>

:::info

In the future PlanDev plans to provide more metadata like a name or user defined version number to differentiate expansion sets from mission models and command dictionaries more effectively.
...
<figure>
  <img alt="PlanDev UI - Expansion Sets Create Page" src={setsCreatePage} />
  <figcaption>Figure 2: PlanDev UI Expansion Sets Create Page</figcaption>
</figure>
