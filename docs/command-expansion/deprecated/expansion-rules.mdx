...
Expansion rules describe a set of commands corresponding to a given activity type. Every (relevant) instance of that activity type can then be expanded according to this rule.

## Managing

Navigate to the "Expansion" page from the PlanDev UI top-level menu, to view, edit or delete existing expansion rules.
The expansion rules page shown in Figure 1 below lists all expansion rules authored by any user who has access to the PlanDev deployment.
Click on "New" above the table to the right to create a new expansion rule.

<figure>
  <img alt="PlanDev UI - Expansion Rules Page" src={rulesPage} />
  <figcaption>Figure 1: PlanDev UI Expansion Rules Page - View, create, or delete expansion rules</figcaption>
</figure>
...
<figure>
  <img alt="PlanDev UI - Expansion Rules Editor" src={rulesEditor} />
  <figcaption>Figure 2: PlanDev UI Expansion Rules Editor</figcaption>
</figure>
...
<figure>
  <img alt="PlanDev UI Expansion Rules Editor - Command Autocomplete" src={rulesEditorCommandAutocomplete} />
  <figcaption>Figure 3: PlanDev UI Expansion Rules Editor - Command Autocomplete</figcaption>
</figure>

<figure>
  <img alt="PlanDev UI Expansion Rules Editor - Command Arguments Error" src={rulesEditorCommandArgsError} />
  <figcaption>Figure 4: PlanDev UI Expansion Rules Editor - Command Arguments Error</figcaption>
</figure>
...
<figure>
  <img alt="PlanDev UI Expansion Rules Editor - Command Arguments for Activity" src={rulesEditorCommandArgs1} />
  <img alt="PlanDev UI Expansion Rules Editor - Command Arguments for Activity" src={rulesEditorCommandArgs2} />
  <figcaption>Figure 5: PlanDev UI Expansion Rules Editor - Passing Command Arguments from Activity</figcaption>
</figure>
...
The PlanDev expansion API exposes duration, computed attributes and similar data that is **only** available post simulation.
