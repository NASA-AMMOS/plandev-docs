...
See some examples in the [mission model template repo](https://github.com/NASA-AMMOS/aerie-mission-model-template), the PlanDev [mission model tutorial](https://github.com/NASA-AMMOS/aerie-modeling-tutorial), or see the procedural [constraints page](../constraints/introduction) of the docs.
