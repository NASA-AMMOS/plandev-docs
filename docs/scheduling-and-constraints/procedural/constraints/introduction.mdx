...
```java
@ConstraintProcedure
public record BatteryAboveZero() implements Constraint {
  @Override
...
constraints to be reported and visualized by PlanDev. A few of the PlanDev [Timelines](../timelines/introduction.mdx) objects will come in handy as you manipulate information available within the `Plan` and `SimulationResults` objects:
