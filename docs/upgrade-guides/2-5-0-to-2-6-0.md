...
For more details about these changes, see [PR #1315](https://github.com/NASA-AMMOS/plandev/pull/1315)

## `scheduling_specifications` relationship changed to `scheduling_specification` ([#1355](https://github.com/NASA-AMMOS/plandev/pull/1355))
