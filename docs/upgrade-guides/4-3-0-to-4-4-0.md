...
* Deployment operators should verify that only documented public ports are exposed.
...
All user-provided Java code must update these imports, recompile against the 4.4.0 libraries, and reupload the resulting JARs.
This includes mission models, procedural scheduling goals, procedural constraints, and other Java code that references PlanDev classes.
