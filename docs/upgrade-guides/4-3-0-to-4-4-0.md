...
Existing Java Mission Models, scheduling goals, and constraints will require changes for the 4.4.0 Java package rename. See the [Java Packages](#java-packages) section for instructions for updating Java source projects, or the following section for migration options for existing compiled JAR files.
