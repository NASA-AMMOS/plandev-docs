...
### Activity Directive New Primary Key ([#380](https://github.com/NASA-AMMOS/plandev/pull/380))
...
### Improved Test Ergonomics ([#382](https://github.com/NASA-AMMOS/plandev/pull/382))
...
Please reference [this diff](https://github.com/NASA-AMMOS/plandev/commit/de36ac4983dbc830b3691077439758fdd0491eee#diff-d2f70599d51fd583111cde71d52820ccaec50abc4d13ae62c30e5ae10b97d8b9) which makes these updates to one of our example mission models.

### Move 'TaskFactory' from Framework to Protocol ([#382](https://github.com/NASA-AMMOS/plandev/pull/382))
...
### Remove 'RootModel' ([#382](https://github.com/NASA-AMMOS/plandev/pull/382))
...
### Update Constraint Boolean Operator Names ([#407](https://github.com/NASA-AMMOS/plandev/pull/407))
...
### Rename "condition" table to "constraint" ([#419](https://github.com/NASA-AMMOS/plandev/pull/419))
...
### SimulationResults Java Class No Longer Provides 'resourceSamples' Field ([#423](https://github.com/NASA-AMMOS/plandev/pull/423))
...
### Rename 'command-expansion-server' to 'sequencing-server' ([#439](https://github.com/NASA-AMMOS/plandev/pull/439))
